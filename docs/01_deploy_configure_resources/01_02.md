...
On the **Models** page, enter `gpt-5-mini` in the search box and select the **gpt-5-mini** model from the list. Then, select **Confirm** to create a gpt-5-mini deployment in your project.

![Select the gpt-5-mini model.](../../media/Solution/0102_Foundry3.png)

Select the **Deploy** button and then choose **Custom settings**. On the modal dialog, select **Agree and proceed** to deploy the model.
- **gpt-5-mini** use TPM:100,000
- **text-embedding-3-large** use TPM:20,000
- **Phi-4** use **Standard settings** with default value

![Deploy the gpt-5-mini model.](../../media/Solution/0102_Foundry4.png)

Repeat this process for **phi-4** and **text-embedding-3-large**. You will have three model deployments in total.
