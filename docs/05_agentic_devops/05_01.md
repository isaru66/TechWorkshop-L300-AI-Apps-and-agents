...
In your VSCode,Codespace. Open Github Copilot to help writing Github Action.

![Select the GitHub Copilot icon while in your repository.](../../media/Solution/0501_GitHub_Copilot_01.png)
...
```
![Ask Github Copilot](../../media/Solution/0501_GitHub_Copilot_02.png)
...
![Let Github Copilot write worklfow](../../media/Solution/0501_GitHub_Copilot_03.png)
...
Then, remove github/ from .gitignore file
![Remove /github from .gitignore](../../media/Solution/0501_GitHub_Copilot_04.png)
Then Commit and push the change to your fork repository.
